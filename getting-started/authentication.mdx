...
[Learn how to generate your API key here.](https://help.neetocrm.com/articles/api-keys)
...
<CodeGroup>
```bash .env
NEETOCRM_API_KEY=your_api_key_here
NEETOCRM_WORKSPACE=your-workspace
```

```javascript JavaScript
// Load from environment
const apiKey = process.env.NEETOCRM_API_KEY;
const workspace = process.env.NEETOCRM_WORKSPACE;
```

```python Python
import os

api_key = os.getenv('NEETOCRM_API_KEY')
workspace = os.getenv('NEETOCRM_WORKSPACE')
```
