...
description: "Understand the HTTP status codes returned by the NeetoCRM API."
---
...
<ResponseField name='429 Too Many Requests'>
  Rate limit exceeded. Try again after some time or implement exponential backoff for retries.
</ResponseField>
